  ...
  return (
    ...
    */}
    <div className={`min-h-screen bg-[#F9F7F2] text-[#2D2D2D] font-sans overflow-x-hidden md:cursor-none ${loading ? 'h-screen overflow-hidden' : ''}`}>
      ...
      {/* --- GLOBAL TEXTURE OVERLAY (PAPER EFFECT) --- */}
      {/* Opacity Reduced from 0.4 to 0.2 to prevent text merging.
          Z-0 ensures it stays behind interactive elements.
      */}
      <div 
            ...
            <div className="w-full lg:w-5/12 relative group flex justify-center">
              <Reveal>
                  ...
                  <div className="relative w-64 h-64 md:w-80 md:h-80">
                      ...
                      {/* Z-index increased to 60 to ensure clickability above texture */}
                      <div 
                        className={`absolute -top-6 -right-6 z-[60] cursor-pointer ${planeFlying ? 'animate-fly-away' : 'animate-float'}`}
                      ...
                      {/* Shadow moved to top-0 right-0 and rotated to sit "below" the plane visual */}
